export default function WebhookSlot({ type }) {
  return (
    <div className="w-full md:ml-[15rem] md:mt-6 mt-6 mt:px-0 mx-6 rounded-lg border border-slate-400 shadow sm:rounded-lg md:w-[40rem] 2xl:w-[64rem] md:min-w-[32rem]">
